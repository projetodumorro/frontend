  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4 bg-[#]'>
      ...
      <ul className='hidden md:flex text-orange-500'>
        ...
        <Link to='/categoria' className='p-4 hover:underline text-xl py-4 flex'>Categorias</Link>
        ...
        <Link to='/carrinho'>
          <button className='p-4 text-black hidden md:flex center p-1'><BsFillCartFill size={25} className='md:flex' /></button></Link>
      </ul>

          ...
          <div className="w-[300px] h-[525  px] bg-slate-50 text-gray-700 shadow-lg rounded-md overflow-hidden py-5" key={index}>
            ...
            <div className='p-5 flex flex-col gap-3'>
              ...
              <div className='flex mt-5 gap-2'>
                <button className='w-full text-white font-bold bg-orange-500/80 hover:bg-orange-500 rounded-md flex items-center justify-center py-2' onClick={() => adicionarProduto(item)} >
                  Adicionar ao Carrinho
                </button>
                <button className='w-full text-white font-bold bg-black/80 hover:bg-black rounded-md flex items-center justify-center py-2'>
...
export default ListaItensProdCliente;